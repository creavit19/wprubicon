...
/******/ 	__webpack_require__.p = "/wp-content/themes/rubicon/dist/";
/******/
...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_materialize_css_dist_js_materialize__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_materialize_css_dist_js_materialize___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_materialize_css_dist_js_materialize__);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  window.M.Sidenav.init(elems1, {}); // Слайдер
  ...
  if (window.select) {
    window.select.oninput = function () {
      showSpiner();
...
function render(data) {
  ...
  data.items.forEach(function (item) {
    ...
    item.foto.forEach(function (imgUrl) {
      htmlData += "<div class=\"carousel-item\"><img src=\"".concat(imgUrl, "\"></div>");
    });
    htmlData += "</div>\n                    </a>\n                    <div class=\"wanted-docket\">\n                      <div class=\"center wanted-name\"><a href=\"".concat(item.link_url, "\" target=\"_blank\">").concat(item.name, "</a></div>\n                      <div class=\"wanted-reward\">").concat(item.reward ? item.reward : '&nbsp;', "</div>\n                      <div class=\"wanted-description\">").concat(item.description, "</div>\n                    </div>\n                  </div>\n                </div>");
  });
  var paginationOn = data.pages > 1;
  var paginBeginSp;
  var paginEndSp;
  var paginLong;
  var paginationBegin;
  ...
  if (paginationOn) {
    ...
    for (var _i = paginationBegin; _i <= paginationEnd; _i++) {
      htmlData += "<span id=\"p".concat(_i, "\" class=\"round").concat(_i == data.page ? ' active' : '', "\">").concat(_i, "</span>");
    }
  ...
  if (paginationOn) {
    ...
    for (var _i2 = paginationBegin; _i2 <= paginationEnd; _i2++) {
      if (_i2 == data.page) continue;
      document.getElementById('p' + _i2).onclick = getPaginationClick(_i2);
    }
  ...
  var slidersWanted = document.querySelectorAll('.wanted-slider .carousel.carousel-slider');
  var instancesSliderWanted = window.M.Carousel.init(slidersWanted, {
    fullWidth: true
  });
  var i = 0;
...
function typing(id) {
  ...
  for (var i = 0; i < window.typingBlock.data.length; i++) {
